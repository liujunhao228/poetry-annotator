...
def get_separate_database_paths(main_db_name: str = "default") -> Dict[str, str]:
    ...
    print(f"DEBUG: main_db_name = {main_db_name}")
    ...
    elif 'db_paths' in db_config and main_db_name in db_config['db_paths']:
        separate_paths = db_config['db_paths'][main_db_name]
        # 解析占位符
        resolved_paths = {}
        for name, path in separate_paths.items():
            # 替换主数据库名称占位符
