...
class Annotator:
    ...
    def __init__(self, config_name: str):
        ...
        # 注意：这里我们暂时保持同步方式创建服务，因为__init__不能是异步的
        # 在run方法中，我们会使用异步方式重新获取服务
        ...
        # INFO级别：初始化信息，简洁明了
        logger.info(f"初始化标注器: 模型配置='{self.model_identifier}', 并发数={self.max_workers}, 保存完整响应={self.save_full_response}")
