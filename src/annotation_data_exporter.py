...
def export_annotations_to_csv(poem_id: int, output_file: str, db_name: str = "default") -> bool:
    """
    ...
    """
    try:
        exporter = AnnotationDataExporter(db_name)
...
def export_annotations_to_excel(poem_id: int, output_file: str, db_name: str = "default") -> bool:
    """
