"""
旧版查询插件适配器
将项目中的CustomQueryPlugin适配为新的Plugin系统
"""
...
class CustomQueryPluginAdapter(QueryPlugin):
    """旧版查询插件适配器"""
    ...
    def _load_query_plugin(self):
        ...
        logger.info(f"旧版查询插件适配器创建成功: {self._name}")
    ...
    def execute_query(self, params=None) -> pd.DataFrame:
        """执行查询"""
