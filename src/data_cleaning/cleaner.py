...
class DataCleaner:
    ...
    def __init__(self, rule_manager: CleaningRuleManager):
        """
        初始化数据清洗器。
    ...
    def clean_poems_data(self, db_name: str = "default", dry_run: bool = False) -> dict:
        """
        清洗诗词数据，标记有问题的数据
        ...
        global_settings = self.rule_manager.get_global_settings()
    ...
    def reset_data_status(self, db_name: str = "default", dry_run: bool = False) -> dict:
        """
        重置所有诗词的数据状态
