# gui/script_panels/proofread_annotations_panel.py
# Implements the ProofreadAnnotationsPanel for the proofread_annotations.py script.
...
class ProofreadAnnotationsPanel(ScriptPanelBase):
    """
    GUI panel for the proofread_annotations.py script.
    Allows users to specify database name and output file, then run the script.
    """
    def __init__(self, parent=None):
        super().__init__("proofread_annotations.py", parent)

    def setup_ui(self):
        """
        Builds the specific UI for the Proofread Annotations script.
        """
        ...
        self.output_file_input.setPlaceholderText(_("Select output file path for proofreading results"))
        ...
        # Run Button
        self.run_button = QPushButton(_("Proofread Annotations"))
