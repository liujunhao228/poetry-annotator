# gui/script_panels/find_duplicate_poems_panel.py
# Implements the FindDuplicatePoemsPanel for the find_duplicate_poems.py script.
...
class FindDuplicatePoemsPanel(ScriptPanelBase):
    """
    GUI panel for the find_duplicate_poems.py script.
    Allows users to specify database name and output file, then run the script.
    """
    def __init__(self, parent=None):
        super().__init__("find_duplicate_poems.py", parent)

    def setup_ui(self):
        """
        Builds the specific UI for the Find Duplicate Poems script.
        """
